...
public class AllDatas {
    ...
    public static final String CREATE_FOLDER_URL = "http://118.192.157.178:8080/XiaoWei/servlet/CreateFolder?folderpath=";//创建文件夹请求地址
    public static final int SELECT_IMAGE_ACTIVITY_CODE=3;
    public static final int UPLOAD_FILE_MAX_NUM=20;  //单次选择图片上传最大数量
    ...
    public static final String VERSION_UPDATA_URL = "http://118.192.157.178:8080/XiaoWei/servlet/VersionUpdata";//版本请求地址
